...
export default function Header() {
  return (
    <header className="text-gray-700 bg-slate-50 shadow-md sticky top-0 bottom-0 backdrop-blur-sm opacity-90">
